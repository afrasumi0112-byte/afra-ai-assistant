...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Afra's personal AI assistant. "
        f"Your job is to help users learn about Afra's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Afra. "
        ...
        f"Answer in third person when talking about Afra, but you may use natural conversational language "
